...
const SwitchChainTooltip = (
  <div>
    ...
    <Text width="80%" fontSize="12px" bold mb="26px" mt="12px" color="textSubtle">
      {/*  @ts-ignore */}
      You are currently browsing Web3GO on {chainKey === 'SDN' ? 'SDN' : 'BSC'} network
    </Text>
    <Flex
      ...
      background="#1A1A22"
      borderRadius="16px"
      onClick={() => (window.location.href = 'https://www.Web3GO.finance/')}
    >
    ...
    <Flex
      ...
      background="#1A1A22"
      borderRadius="16px"
      onClick={() => (window.location.href = 'https://shiden.Web3GO.finance/')}
    >
      <Flex alignItems="center">
