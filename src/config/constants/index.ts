...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.ASTR_TESTNET]: [Base_Token, ETH[chainId], Web3GO, BUSD[chainId]],
  ...
  [ChainId.SDN_TESTNET]: [Base_Token, ETH[chainId], Web3GO, BUSD[chainId]],

  [ChainId.BSC_MAINNET]: [
    Base_Token,
    Web3GO[ChainId.BSC_MAINNET],
  ...
  [ChainId.BSC_TESTNET]: [Base_Token, Web3GO[ChainId.BSC_TESTNET], BUSD[chainId]],
};
/**
...
export const SUGGESTED_BASES: ChainTokenList = {
  [ChainId.ASTR_MAINNET]: [BUSD[ChainId.ASTR_MAINNET], Web3GO, BTCB[ChainId.ASTR_MAINNET]],
  [ChainId.ASTR_TESTNET]: [ETH[chainId], Web3GO, BUSD[ChainId.ASTR_TESTNET]],

  [ChainId.SDN_MAINNET]: [BUSD[ChainId.SDN_MAINNET], Web3GO, BTCB[ChainId.SDN_MAINNET]],
  [ChainId.SDN_TESTNET]: [ETH[chainId], Web3GO, BUSD[ChainId.SDN_TESTNET]],

  [ChainId.BSC_MAINNET]: [BUSD[ChainId.BSC_MAINNET], Web3GO, BTCB[ChainId.BSC_MAINNET]],
  [ChainId.BSC_TESTNET]: [ETH[chainId], Web3GO, BUSD[chainId]],
};
...
export const BASES_TO_TRACK_LIQUIDITY_FOR: ChainTokenList = {
  ...
  [ChainId.ASTR_TESTNET]: [ETH[chainId], Web3GO, BUSD[chainId]],
  ...
  [ChainId.SDN_TESTNET]: [ETH[chainId], Web3GO, BUSD[chainId]],
